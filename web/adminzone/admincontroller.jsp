...
<%
  ...
  else if(request.getParameter("page").equals("qb"))
  {
      ...
      if(dm.insertUpdateDelete(query)==true)
      {
          out.print("<script>alert('Questio is added');window.location.href='qb.jsp';</script>");
      }
      else
      {
        out.print("<script>alert('Questio is not added');window.location.href='qb.jsp';</script>");   
      }
  }
