    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12" style="min-height: 500px;background:linear-gradient(-15deg,rgba(255,255,255,.4),rgba(0,0,0,.7)),url(images/);min-height:70vh;background-repeat:no-repeat;background-size:100% 100%;">           
                <div class="col-sm-12" style="min-height:600px;background-color:lightcoral"></div>
            </div>
</div>
            <div class="row">
              <div class="col-sm-6" style="min-height:80px;background-color:blue;color:white;font-size:30px; float: left; text-align:center;line-height: 80px;">
                    copyright &copy; To Nalanda Open University
                </div>
                <div class="col-sm-6" style="min-height:80px;background-color:aqua;color:white;font-size:30px; float: left; text-align:center;line-height: 80px;">
