...
<%
    if (request.getParameter("page").equals("contactus")) {
        ...
        String query2 = "insert into login value('" + rollno + "','" + password + "','student','false')";
        ...
        if (rs.next()) {
            ...
            if (usertype.equals("admin")) {
                ...
                response.sendRedirect("studentzone/studenthome.jsp");
                  ...
                  out.print("<script>alert('valide login');window.location.href='registration.jsp';</script>");
           } 
         else {
              out.print("<script>alert('invalide login');window.location.href='registration.jsp';</script>");
        }
    }
%>
